...
<div class="tray-container">
  ...
  <header class="tray-header" data-tauri-drag-region>
    <div class="brand" data-tauri-drag-region>
      ...
      <div class="brand-titles">
        ...
        <span class="brand-section">Secrets</span>
      </div>
    </div>
  ...
  {:else}
    ...
    <div class="tray-body">
      ...
      <!-- 100% Full Width Search & Add Variable Toolbar -->
      ...
      <!-- Separated Variables List -->
      <div class="secrets-container">
        {#if !selectedProfile || selectedProfile.secrets.length === 0}
          <div class="empty-state">
            <div class="empty-icon"><Anchor size={22} strokeWidth={1.8} /></div>
...
<style>
  ...
  :global(.profile-select-trigger:focus-visible) {
    border-color: var(--color-east-bay-500) !important;
  ...
  /* 100% Full Width Search & Action Toolbar */
  .search-section {
    align-items: center;
    background: #ffffff;
    border-bottom: 1px solid var(--color-boulder-200);
